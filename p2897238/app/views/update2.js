                ...
                <div class="short-info">
                    ...
                    <div class="general-info">
                        <div class="error-message">
                            ...
                            <input type="text" id="update_title" name="first_title" value="${escape(article.title)}" required minLength="5">
                            ${first_title.message}
                        </div>

                        <div class="error-message">
                            <label for="update_date">Date:</label>
                            <input type="date" id="update_date" name="first_date" value="${escape(article.date)}" required>
                            ${first_date.message}
                        </div>

                        <div class="error-message">
                            <label for="update_idName">ID-Name:</label>
                            <input type="text" id="update_idName" name="first_idName" value="${escape(article.idName)}" readonly >
        ...
        const second_news = second.map(news_article => `
            ...
            <fieldset>
                ...
                <div class="error-message-2">
                    ...
                    <input type="text" id="update_title_1" name="second_title" value="${escape(news_article.news_title_1)}" required minLength="5">
                    ${second_title.message}
                </div>

                <div class="error-message-2">
                    <label for="update_title_2">Header:</label>
                    <input type="text" id="update_title_2" name="second_header" value="${escape(news_article.news_title_2)}" required minLength="5">
                ...
                <div class="error-message-2">
                    ...
                    <input type="text" id="update_title_3" name="second_header_2" value="${escape(news_article.news_title_3)}" required minLength="5">
                ...
                <div class="error-message-2">
                    ...
                    <input type="text" id="update_title_4" name="second_header_3" value="${escape(news_article.news_title_4)}" required minLength="5">
                ...
                <div class="error-message-2">
                    ...
                    <input type="text" id="update_title_5" name="second_header_4" value="${escape(news_article.news_title_5)}" required minLength="5">
